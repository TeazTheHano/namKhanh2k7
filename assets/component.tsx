...
export function avatarComponet(w: number = vw(12), h: number = vw(12)) {
    return (
        <View style={[styles.borderRadius100, styles.marginHorizontal2vw, { width: w, height: h, backgroundColor: clrStyle.main1 }]}>
            <SvgXml xml={`
